import { Drama, ChevronLeft, ChevronRight } from "lucide-react";
...
export interface RecentlyAddedShowsSectionProps {
  items: BaseItemDto[];
  serverUrl: string;
  loading: boolean;
    ...
    <section className="mr-10">
      <div className="flex items-center justify-between ml-16">
        <button
          ...
          onClick={() => navigate("/recently-added/shows")}
        >
          <Drama className="size-5 inline-block mr-2" /> Recently added in TV
          Shows
